...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "database_ABI";
    private static final String TABLE_NAME = "table_ABI";
    ...
    public void onCreate(SQLiteDatabase data) {
        String thisTable = "create table if not exists " + TABLE_NAME +
                "(id INTEGER PRIMARY KEY, txt TEXT)";
        data.execSQL(thisTable);
    }
